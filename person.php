...
if($last_chat	and (!$last_contact or !@strcmp($last_contact['start_on'], $last_chat['start_on'])))	$last_contact = $last_chat;
if($last_phone	and (!$last_contact or !@strcmp($last_contact['start_on'], $last_phone['start_on'])))	$last_contact = $last_phone;
if($last_met	and (!$last_contact or !@strcmp($last_contact['start_on'], $last_met['start_on'])))	$last_contact = $last_met;
